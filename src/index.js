...
$(".scrollIt").on("click", function(event) {
	...
	$(window).scroll(function(){
		...
		if (scroll >= 270) sticky.addClass('fixedDiv');

		else sticky.removeClass('fixedDiv');
	});
	...
	$('.teacherListBlocks .delete').keypress(
		deleteTeacher
	...
	$('.teacherListBlocks .deleteOption').keypress(
		deleteOption
	...
	$('.teacherListBlocks .cancelOption').keypress(
		cancelOption
	...
	$('.teacherListBlocks .link').keypress(
		linkEdit
